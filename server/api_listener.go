...
import (
	...
	"github.com/renatomb/open-rport/db/migration/api_token"
	...
	"github.com/renatomb/open-rport/server/notifications/channels/scriptRunner"
	"github.com/renatomb/open-rport/server/notifications/channels/toLog"
	notificationsSQLite "github.com/renatomb/open-rport/server/notifications/repository/sqlite"
	...
	"github.com/renatomb/open-rport/server/script"

	"github.com/renatomb/open-rport/server/api"
	"github.com/renatomb/open-rport/server/api/command"
	...
	"github.com/renatomb/open-rport/server/vault"
...
func NewAPIListener(
	...
	notificationsCleaner := notificationsSQLite.StartCleaner(notificationLogger, store, config.Notifications.LogStorageDuration, config.Notifications.CleanupInterval)
